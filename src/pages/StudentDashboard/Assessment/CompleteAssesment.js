...
import { CompleteAssessApi } from "../../../Api/CompleteAssesApi";

const CompleteAssesment = () => {
  const [data, setData] = useState(CompleteAssessApi);
  return (
