  ...
  return (
    <div className='flex flex-col justify-between h-[80vh]'>
      ...
      <div className='flex items-center'>
        ...
        <div className='completionSummary border-2 h-[200px] w-[400px] flex flex-col mx-6 justify-evenly pl-2 border-gray-400'>
          <p className='self-center text-lg font-medium text-gray-600'>
            completion summary
          </p>
          <p>Teacher Name: XYZ</p>
          <p>Assessment Completion: 40%</p>
          <div className='aggregate_percent w-full flex items-center'>
            Aggregate of Completion:
            <div className='min-w-[100px] mx-2'>
              <div className='max-w-[100px] bg-gray-200 rounded-full h-2.5 dark:bg-gray-700  '>
                <div
...
export default AdminTeacherAssessment;
